...
#Load Data:
Bison_numbers = read_csv("C:/Users/kdfro/Documents/MSU/GitHub/ECNS-560-Term-Project-2/Data/Bison_numbers_by_the_county National Bison Association.csv")
hunting_data_tidy = read_excel("C:/Users/kdfro/Documents/MSU/GitHub/ECNS-560-Term-Project-2/Data/hunting_data_tidy.xlsx")
```
...
```{r}
setwd("C:/Users/kdfro/Documents/MSU/GitHub/ECNS-560-Term-Project-2")
...
#Clean some data sets based on what I want in each visualization:
...
ggplot(graph2_data, aes(x = `Paid Hunting License Holders`, y = total_population)) +
  geom_point() + 
  geom_smooth() +
...
Canada = st_read("C:/Users/kdfro/Documents/MSU/GitHub/ECNS-560-Term-Project-2/Data/ca_shp/ca.shp")
...
ggplot(distance, aes(x = distance, y = difference)) + 
...
library(broom)
lat_pop_model <- lm(difference ~ distance, data = distance)
...
distance_hunting_land2 = distance_hunting_land |>
  filter(ABBREV != "ID") |>
  filter(ABBREV != "MT")
#Removing these states is justified based on explanation in exploratory analysis.
...
Final Research Question: The impact of Market Price on Population
```{r}
#Load Data:
price_data <- read_csv("C:/Users/kdfro/Documents/MSU/GitHub/ECNS-560-Term-Project-2/Data/Price.csv")

#get average by year:
price_data_year = price_data |>
  mutate(Date = stringr::str_sub(price_data$Date, -4)) |>
  group_by(Date) |>
  summarize(ave_price = mean(Avg_Price)) |>
  rename(year = Date) |>
  filter(year == "2012" | year == "2017")

#Unfortunately, this is not enough data to draw meaningful conclusions. However, the dramatic increase in market price could be a result of the corresponding shift in the supply curve of Bison.
```


Some Basic Histograms of Single Variables:
```{r}
hist(distance_hunting_land2$difference, main = "% Decrease in Bison Population 2002 - 2017", xlab = "% Decrease", col = "red") #histogram of percent decrease in bison populations from 2002-2017

hist(distance_hunting_land2$total_population, main = "Total Bison Population in 2017", xlab = "Population", col = "lightblue") #histogram of total bison populations

hist(distance_hunting_land2$`Paid Hunting License Holders`, main = "Number of Hunting License Holders in 2017", xlab = "Number of Hunting License Holders", col = "lightgreen") #histogram of number of hunting license holders from 2002-2017

hist(distance_hunting_land2$public, main = "% of Land that is Public", xlab = "% of Land that is Public", col = "lightyellow") #histogram of percent of land that is public from 2002-2017
```
